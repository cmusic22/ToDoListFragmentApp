...
public class MainActivity extends AppCompatActivity implements
	...
	public void newItemCreated(ToDoItem newItem) {
		...
		//get reference to ToDoListFragment ftom the FragmentManager
	...
	public void itemSelected(ToDoItem selected) {
		...
		//Add to the back stack, so if user presses back button fromthe Detail Fragment,
		// it will revert this transaction - Activity will remove the Detail Fragment, showin the Add+List fragments
